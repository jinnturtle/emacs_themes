...
(custom-theme-set-faces
 ...
 `(isearch ((t (:inverse-video t :foreground ,color-02 :background ,color-backgroundL1))))
 `(isearch-fail ((t (:inverse-video t :background ,color-backgroundL1 :inherit (font-lock-warning-face)))))
 `(lazy-highlight ((t (:inverse-video t :foreground ,color-02 :background ,color-background))))
